public class Variables {
  ...
  private Integer createdVariable = new Integer();

  private List<String> genericList = new ArrayList<>();
  private final Map<String, Button> buttonMap = new HashMap<>();
  private Bean<String> genericBean = new Bean<String>("primary");
  private Bean<String> genericBean = new Bean<String>("primary", "secondary", "tertiary", "archive");
  private Map<Integer, String> indexedLabels = new HashMap<Integer, String>();
  private Map<Integer, String, Integer, String> indexedLabelPairs = new HashMap<Integer, String, Integer>();

  private Object objectWithComment1 /* comment */= new Object();
  private Object objectWithComment2 =/* comment */ new Object();
  private Object objectWithComment3 /* very very very long comment */= new Object();
  private Object objectWithComment4 =/* very very very long comment */ new Object();
  ...
  public void breakVariables() {
    ...
    Object.test.creation thisObject5 = classWithName.invocationOne(firstArgumentWithAVeryVeryVeryVeryLongName, secondArgument, thirdArgument).attributeOne.attributeTwo
        .invocationTwo(firstArgument, secondArgument).attributeThree.invocationThree();

    Object.test.creation thisObject6 = classWithName.invocationOne(firstArgument, secondArgument,
        thirdArgument).attributeOne.attributeTwo.invocationTwo(firstArgument, secondArgument).attributeThree.invocationThree();
  }
  ...
  public void breakAfterEquals() {
    ...
    Object longInvoiceProjectionForIllustrativePurposes = InvoiceProjectionFactory.createDefaultProjection();

    Object longInvoiceProjectionForIllustrativePurposes = someMethod();
    ...
    Object longInvoiceProjectionForIllustrativePurposes = existingInvoiceProjection !=
      null
  ...
  public <A extends ShortClassName & ShortClassName & ShortClassName & ShortClassName, B extends ShortClassName & ShortClassName & ShortClassName & ShortClassName & ShortClassName, C extends ExtremelyLongAndObnoxiousClassName<ExtremelyLongAndObnoxiousClassName<ExtremelyLongAndObnoxiousClassName, ExtremelyLongAndObnoxiousClassName>, ExtremelyLongAndObnoxiousClassName> & ExtremelyLongAndObnoxiousInterfaceName & ExtremelyLongAndObnoxiousInterfaceName & ExtremelyLongAndObnoxiousInterfaceName> void breakOnTypeArguments(
    ...
    ExtremelyLongAndObnoxiousClassName<ExtremelyLongAndObnoxiousClassName<ExtremelyLongAndObnoxiousClassName, ExtremelyLongAndObnoxiousClassName>, ExtremelyLongAndObnoxiousClassName> longInvoiceProjectionForIllustrativePurposes =
      new MyExtremelyLongAndObnoxiousClassName<ExtremelyLongAndObnoxiousClassName<ExtremelyLongAndObnoxiousClassName, ExtremelyLongAndObnoxiousClassName>, ExtremelyLongAndObnoxiousClassName>();
  ...
  void assignment() {
    ...
    selectedRegion =
      hasDedicatedRegion ? dedicatedRegion : sharedRegion;

    pendingInvoiceProjection = currentInvoiceProjection = subtotalAmount + taxAmount;

    invoice = new Invoice("draft-000000000001", "review-000000000002", "approved-0000000003", "archived-0000000004", "restored-0000000005", "deleted-00000000006");

    final Invoice storedInvoice = new Invoice("draft-000000000001", "review-000000000002", "approved-0000000003", "archived-0000000004", "restored-0000000005", "deleted-00000000006");

    int firstIndex, secondIndex, thirdIndex = 1;
  }
}

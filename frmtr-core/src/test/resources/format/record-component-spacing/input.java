...
public record Pet(
@NotNull String name, int age, String... nicknames, Object @Nullable... validationArgs
    ) {
public Pet {
    if (age < 0) {
...
class MyRecordConstructor {
    record CustomerRecord(String name,
     int age) {
...
public interface CustomerProjection {
    record CustomerRecord(
        String param) implements CustomerProjection {

         }
}

public interface CustomerProjection {
  record CustomerSplitRecord(String param, String param, String param, String param, String param, String param) implements CustomerProjection {}
}
...
record AuditEvent<EventId, TenantId, TraceId, RequestId, CorrelationId, RevisionId>(Payload payload) implements DomainEvent {
...
record AuditEvent<EventId, TenantId, TraceId, RequestId, CorrelationId, RevisionId>(Payload payload) implements DomainEvent, TenantEvent, MeteredEvent, ArchivedEvent, ReplayableEvent, IndexedEvent {

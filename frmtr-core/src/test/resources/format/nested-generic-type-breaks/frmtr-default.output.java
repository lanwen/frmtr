...
public abstract class AbstractGenericClass<
    ...
    PreviousValue extends AbstractValue,
    CurrentValue extends AbstractValue,
    NextValue extends AbstractValue,
    ArchivedValue extends AbstractValue,
    PendingValue extends AbstractValue
> {

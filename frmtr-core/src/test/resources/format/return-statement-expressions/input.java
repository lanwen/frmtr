public abstract class Return {
  ...
  boolean routeConstructorBudgetFits(RouteProfile routeProfile, RouteMeter routeMeter, Layout layout, RouteRequest routeRequest, Options options, String routeLabel) {
    return (
  ...
  boolean routeSignalOperator(RouteBinaryExpression matcher) {
    return (
        matcher.getOperator() == RouteBinaryExpr.Operator.INBOUND

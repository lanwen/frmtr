public abstract class Throws {
  ...
  abstract void abstractThrowServiceException3(String requestId, String accountId, String region) throws RuntimeException;

  abstract void abstractThrowServiceException4() throws RuntimeException, RuntimeException, RuntimeException;

  abstract void abstractThrowServiceException5(String requestId) throws RuntimeException, RuntimeException, RuntimeException;
  ...
  public Throws(String requestId)
      throws RuntimeException {
    System.out.println("Constructor with throws that should not wrap");
  }

  public Throws(String requestId, String accountId, String region)
      throws RuntimeException {

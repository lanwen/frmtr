class CatalogWarehouse {
    ...
    static class InventoryLedger extends AbstractLedger implements Auditable, Serializable {
        ...
        static class NestedRecordArchiveWithRetention<EntryRecord, RetentionPolicy>
            extends ArchiveFrame<EntryRecord, RetentionPolicy>
            permits SealedArchive {

            void archive() {}
        }
    }

    static class ShipmentTrackerWithExtendedAuditTrail
        extends AbstractShipmentTracker

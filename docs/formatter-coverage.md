...
| `FieldDeclaration` | `FieldDeclarationPrinter` | Owns field declarations, variables, initializer break decisions, huggable block-lambda method-call initializers, switch-expression initializer body preservation, and shared variable initializer policy. |

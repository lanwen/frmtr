public class BinaryOperations {
    ...
    public boolean binaryOperationWithComments() {
        boolean a = one || two >> 1 // one // two // three || // five // four three;

        boolean b = one || two >> 1 // one // two // three || three;

        boolean c = one || two >> 1 // one // two // three || three;
    ...
    void instanceOf() {
        var a = a && Foo.get(longlinelonglinelonglinelonglinelongline) instanceof NumberNumberNumberNumber n && n.foo();

        var a = Foo.get(longlinelonglinelonglinelonglinelongline) instanceof NumberNumberNumberNumber n && n.foo();

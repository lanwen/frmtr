...
final class MethodChainTrailingEmptyCallComment {
    ...
    private RoutedHarnessCatalog<PrimaryRoutePlan, SecondaryWorkerPlan, ArchiveFallbackPlan, DeferredAuditPlan> fieldTypeBreaksBeforeChainWithWideDeclarationPrefix = new RelaySubject<>(ImageName.parse("relay:4.4"))

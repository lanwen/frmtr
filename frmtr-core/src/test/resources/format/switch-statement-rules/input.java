class Switch {
  ...
  public String shouldWrapEvenForSmallSwitchCases() {
    switch (decision) { case "YES": return "YES"; default: return "NO"; }
  }
  ...
  public void multipleCaseConstants(RoutingMode routingMode) {
    switch (routingMode) {
      ...
      case REMOTE, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID, HYBRID -> System.out.println("Not local!");

...
**Status:** 🟣 Investigating · _focused proposal:_ [linear-time-doc-renderer.md](linear-time-doc-renderer.md)
...
(`6e4f600a`), leaving M2 to add only the memoization and bounded lookahead.

...
class RequestValidator {
    ...
    void acquireIfAvailableFits(ConnectionRequest pendingConnectionRequest) {
        if (isSlotAvailable(pendingConnectionRequest)) totalAcceptedConnectionRequestsAcrossAllActiveRetryWindowsNow++;
    }
    ...
    void acquireOrRejectFits(ConnectionRequest pendingConnectionRequest) {
        if (isSlotAvailable(pendingConnectionRequest)) totalAcceptedConnectionRequestsAcrossAllActiveRetryWindowsNow++; else {

public class Cast {
    ...
    void should_cast_with_additional_bounds() {
        ...
        consume((VeryLongReadableProjectionType & VeryLongAuditableProjectionType & VeryLongVersionedProjectionType) candidate);
        consume((VeryLongReadableProjectionType & VeryLongAuditableProjectionType & VeryLongVersionedProjectionType) (sourceValue, value) -> sourceValue + value);
    }
    ...
    void intersectionCastExpression() {
        ...
        Object castResult3 = (Readable & Auditable) switch (x) { default -> null; };

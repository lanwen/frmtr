    ...
    static class SettlementReconciler {
        ...
        ReconciliationOutcome reconcile(ReconciliationRecord record) {
            return switch (record) {
                case OuterReconciliationRecord(
                    InnerLedgerPostingRecord(
                        String firstLongReconciliationFieldName,
                        String secondReconciliationFieldName
                    ),
                    Totals totalsSummaryValue
                ) -> {

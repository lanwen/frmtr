...
plugins {
    java
    id("dev.lanwen.frmtr") version "0.2.0"
}
```

Snapshot builds are published from `main`. Current snapshot: `0.2.1-SNAPSHOT`; see
...
```kotlin
plugins {
    id("dev.lanwen.frmtr") version "0.2.0" apply false
}

...
final class SubscriptionRegistrar {
    ...
    void configure() {
subscriptionCoordinatorRegistry.registerLifecycleSubscriptionHandler(subscriptionRequestContext -> subscriptionRequestContext.isPriorityChannelActive() ? primaryDispatchStrategy : fallbackDispatchStrategy);
    }
}

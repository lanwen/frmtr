...
| `SourceShape` | Source-line-shape predicates that let printers preserve existing multiline forms without scanning whole declarations or owning the resulting doc layout, including method-call operands, nested source-multiline method-call arguments, and logical control-condition shape. |

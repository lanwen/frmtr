...
final class WideImplementation
    extends BaseImplementation<FirstSubject, SecondSubject, ThirdSubject>
    implements FirstSubject, SecondSubject {
...
class BatchImportHandler<InputEnvelope, OutputEnvelope>
    extends ImportHandler<SourceRecord, TargetRecord, ErrorRecord, AuditRecord, RetryRecord> {

    void runImport() {}
}

class BatchImportHandler<InputEnvelope, OutputEnvelope>
    extends ImportHandler<SourceRecord, TargetRecord>
    implements RetryableHandler, AuditedHandler {
...
class BatchImportHandler<InputEnvelope, OutputEnvelope, MetadataEnvelope, ErrorEnvelope, AuditEnvelope, RetryEnvelope>
    extends ImportHandler<SourceRecord, TargetRecord>
    implements RetryableHandler, AuditedHandler {
...
class BatchImportHandler<InputEnvelope, OutputEnvelope, MetadataEnvelope, ErrorEnvelope, AuditEnvelope, RetryEnvelope>
    extends ImportHandler<SourceRecord, TargetRecord, ErrorRecord, AuditRecord, RetryRecord, ArchiveRecord>
    implements
        RetryableHandler,
        AuditedHandler,
        MeteredHandler,
...
public class ConcreteReportWriter
    extends AbstractReportWriter
    implements CsvExport, PdfExport, AuditExport, ArchiveExport {
